...
set_property -dict {PACKAGE_PIN K19 IOSTANDARD LVCMOS25} [get_ports enable]
set_property -dict {PACKAGE_PIN L17 IOSTANDARD LVCMOS25} [get_ports txnrx]
...
set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS33} [get_ports {gpio_ctl[0]}]
set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVCMOS33} [get_ports {gpio_ctl[1]}]
set_property -dict {PACKAGE_PIN P15 IOSTANDARD LVCMOS33} [get_ports {gpio_ctl[2]}]
set_property -dict {PACKAGE_PIN P16 IOSTANDARD LVCMOS33} [get_ports {gpio_ctl[3]}]
...
set_property -dict {PACKAGE_PIN R19 IOSTANDARD LVCMOS33} [get_ports gpio_clksel]

#set_property PACKAGE_PIN M14 [get_ports spi_csn]
