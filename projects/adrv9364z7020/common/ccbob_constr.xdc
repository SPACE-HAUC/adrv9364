...
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS25} [get_ports {gpio_bd[8]}] ; ##U1,V15,IO_L10_34_JX4_P,JX4,42,P6,25           968
set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS25} [get_ports {gpio_bd[9]}] ; ##U1,Y18,IO_L17_34_JX4_P,JX4,67,P6,9
set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS25} [get_ports {gpio_bd[10]}] ; ##U1,Y17,IO_L07_34_JX4_N,JX4,37,P6,20

## ps7 gpio

set_property -dict {PACKAGE_PIN V20 IOSTANDARD LVCMOS25} [get_ports {gpio_bd[11]}] ; ##U1,V20,IO_L16_34_JX4_P,JX4,58,P7,5           971
set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS25} [get_ports {gpio_bd[12]}] ; ##U1,V17,IO_L21_34_JX4_P,JX4,77,P7,26
set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS25} [get_ports {gpio_bd[13]}] ; ##U1,R17,IO_L19_34_JX4_N,JX4,75,P7,20
set_property -dict {PACKAGE_PIN P20 IOSTANDARD LVCMOS25} [get_ports {gpio_bd[14]}] ; ##U1,P20,IO_L14_SRCC_34_JX4_N,JX4,54,P7,3
set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS25} [get_ports {gpio_bd[15]}] ; ##U1,R16,IO_L19_34_JX4_P,JX4,73,P7,18          975
set_property -dict {PACKAGE_PIN N20 IOSTANDARD LVCMOS25} [get_ports {gpio_bd[16]}] ; ##U1,N20,IO_L14_SRCC_34_JX4_P,JX4,52,P7,1
set_property -dict {PACKAGE_PIN P19 IOSTANDARD LVCMOS25} [get_ports {gpio_bd[17]}] ; ##U1,P19,IO_L13_MRCC_34_JX4_N,JX4,53,P7,4
set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS25} [get_ports {gpio_bd[18]}] ; ##U1,W14,IO_L08_34_JX4_P,JX4,36,P6,17
...
set_property -dict {PACKAGE_PIN W13 IOSTANDARD LVCMOS25} [get_ports {gpio_bd[26]}] ; ##U1,W13,IO_L04_34_JX4_N,JX4,28,P6,7
set_property -dict {PACKAGE_PIN U15 IOSTANDARD LVCMOS25} [get_ports {gpio_bd[27]}] ; ##U1,U15,IO_L11_SRCC_34_JX4_N,JX4,47,P6,32
...
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS25} [get_ports spi1_mosi]
set_property -dict {PACKAGE_PIN T12 IOSTANDARD LVCMOS25} [get_ports spi1_miso]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS25} [get_ports spi1_clk]
set_property PACKAGE_PIN U13 [get_ports spi1_csn0]
set_property IOSTANDARD LVCMOS25 [get_ports spi1_csn0]
set_property PULLUP true [get_ports spi1_csn0]
set_property PACKAGE_PIN V13 [get_ports spi1_csn1]
set_property IOSTANDARD LVCMOS25 [get_ports spi1_csn1]
set_property PULLUP true [get_ports spi1_csn1]
set_property PACKAGE_PIN T14 [get_ports spi1_csn2]
set_property IOSTANDARD LVCMOS25 [get_ports spi1_csn2]
set_property PULLUP true [get_ports spi1_csn2]

set_property -dict {PACKAGE_PIN U7 IOSTANDARD LVCMOS25} [get_ports {gp_out[0]}]
set_property -dict {PACKAGE_PIN T9 IOSTANDARD LVCMOS25} [get_ports {gp_in[0]}]
set_property -dict {PACKAGE_PIN V7 IOSTANDARD LVCMOS25} [get_ports {gp_out[1]}]
set_property -dict {PACKAGE_PIN U10 IOSTANDARD LVCMOS25} [get_ports {gp_in[1]}]
set_property -dict {PACKAGE_PIN Y7 IOSTANDARD LVCMOS25} [get_ports {gp_out[2]}]
set_property -dict {PACKAGE_PIN Y9 IOSTANDARD LVCMOS25} [get_ports {gp_in[2]}]
set_property -dict {PACKAGE_PIN Y6 IOSTANDARD LVCMOS25} [get_ports {gp_out[3]}]
set_property -dict {PACKAGE_PIN Y8 IOSTANDARD LVCMOS25} [get_ports {gp_in[3]}]
set_property -dict {PACKAGE_PIN V8 IOSTANDARD LVCMOS25} [get_ports {gp_out[4]}]
set_property -dict {PACKAGE_PIN W10 IOSTANDARD LVCMOS25} [get_ports {gp_in[4]}]
set_property -dict {PACKAGE_PIN W8 IOSTANDARD LVCMOS25} [get_ports {gp_out[5]}]
set_property -dict {PACKAGE_PIN W9 IOSTANDARD LVCMOS25} [get_ports {gp_in[5]}]
set_property -dict {PACKAGE_PIN U9 IOSTANDARD LVCMOS25} [get_ports {gp_out[6]}]
set_property -dict {PACKAGE_PIN W11 IOSTANDARD LVCMOS25} [get_ports {gp_in[6]}]
set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS25} [get_ports {gp_out[7]}]
set_property -dict {PACKAGE_PIN Y11 IOSTANDARD LVCMOS25} [get_ports {gp_in[7]}]
set_property -dict {PACKAGE_PIN T5 IOSTANDARD LVCMOS25} [get_ports {gp_out[8]}]
set_property -dict {PACKAGE_PIN Y12 IOSTANDARD LVCMOS25} [get_ports {gp_in[8]}]


set_property -dict {PACKAGE_PIN U5 IOSTANDARD LVCMOS25} [get_ports {uart0_tx}] ; ##U1,U5,IO_L19_13_JX2_N,JX2,63,P2,48
set_property -dict {PACKAGE_PIN Y13 IOSTANDARD LVCMOS25} [get_ports {uart0_rx}] ; ##U1,Y13,IO_L20_13_JX2_N,JX2,64,P2,47

set_property PACKAGE_PIN R18 [get_ports i2c0_scl] ; ##U1,W15,IO_L10_34_JX4_N,JX4,44,IO_L10_34_JX4_N,P6,27
set_property IOSTANDARD LVCMOS25 [get_ports i2c0_scl]
set_property PULLUP true [get_ports i2c0_scl]

set_property PACKAGE_PIN T17 [get_ports i2c0_sda] ; ##U1,T19,IO_25_34_JX4,JX4,64,IO_25_34_JX4,P5,23
set_property IOSTANDARD LVCMOS25 [get_ports i2c0_sda]
set_property PULLUP true [get_ports i2c0_sda]

set_property PACKAGE_PIN W19 [get_ports i2c1_scl] ; ##U1,U19,IO_L12_MRCC_34_JX4_N,JX4,48,P6,31
set_property IOSTANDARD LVCMOS25 [get_ports i2c1_scl]
set_property PULLUP true [get_ports i2c1_scl]

set_property PACKAGE_PIN W18 [get_ports i2c1_sda] ; ##U1,U20,IO_L15_34_JX4_N,JX4,59,P7,8
